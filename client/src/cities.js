...
class Cities extends Component {
  ...
  filterItems = ( query) => {
    this.setState({cities:this.props.cities[0].filter(el => el.ciudad.toLowerCase().indexOf(query.toLowerCase()) !== -1)});
  };
  ...
  render() {
    ...
    return (
        ...
        <div className="cities">
            ...
            <div>
            {(this.state.cities.length == 0) && ( this.props.cities[0])  && (this.props.cities[0].map((city)=>{
               return (
